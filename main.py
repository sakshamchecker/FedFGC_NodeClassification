...
if __name__ == "__main__":
    ...
    parser.add_argument('--ncl', default=10, type=int, help='number of clients')
    ...
    parser.add_argument('--data', default='MUTAG', type=str, help='dataset')
    ...
    parser.add_argument('--cr_ratio', default=0.9, type=float, help='coarsen ratio')
